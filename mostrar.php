  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
        <title>Alumnos | Universidad Alejandro de Humboldt</title>
	    <!-- Bootstrap CSS -->
...
<div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <!-- <h3><img src="../../Assets/img/humboldt.png" class="img-fluid" style="margin: 0 auto; display: block;"/><span style="display: flex; justify-content: center; align-items: center;">Alejandro de Humboldt</span></h3> -->

                <div style="text-align: center;">
                 <img src="../../Assets/img/humboldt.png" width="160" height="140"/>
                </div>
